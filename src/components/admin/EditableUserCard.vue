...
<template>
	<div class="rounded-lg py-2 border-2 border-green-100 flex w-full" :class="editable === 'edit' ? 'bg-gray-300' : 'bg-gray-400'">
		...
		<div v-if="editable === 'edit'" class="w-full flex mx-2 justify-between bg-gray-300">
			<p class="w-1/12 px-2">{{ user.id }}</p>
			<div class="w-3/12">
